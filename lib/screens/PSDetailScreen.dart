...
class PSDetailScreen extends StatefulWidget {
  ...
  PSDetailScreen({this.data,this.wise=false});
...
// openAppWithPackageId('com.transferwise.android');
    ...
    return Scaffold(
      ...
      body:widget.wise==false?  SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // Image.asset('images/playStore/wise.webp',height: 80, width: 80,)
                ,
                8.width,
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Wise', style: boldTextStyle(size: 20)),
                    Text('Wise, formerly TransferWise', style: secondaryTextStyle(color: psColorGreen)),
                    Text("Contains ads In-app purchases", style: secondaryTextStyle()),
                  ],
                ).expand(),
              ],
                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        children: [
                          Icon(Icons.move_to_inbox_rounded, size: 22),
                          Text('22' + "MB", style: secondaryTextStyle(size: 12)),
                        ],
                      ).paddingOnly(right: 16, left: 16),
                      Container(height: 30, width: 1, color: Colors.grey),
                      Column(
